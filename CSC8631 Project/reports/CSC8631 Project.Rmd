...
So the amount of data missing in the cloze_response variable in each file is equal to the total data missing across all question-response files. We should remove this variable when we prepare our data files for analysis as it is just needless clutter. Aside from this variable, the remainder of the data is intact, and we can now begin to prepare our data.
